...
<center>
    <div id="container">
        ...
        <div id="content">
            ...
            請點選類別:
            <input name="class" type="radio" value="C0001">書
            <input name="class" type="radio" value="C0002">電腦
            <input name="class" type="radio" value="C0003">會議室
            <input name="class" type="radio" value="C0004">電器
            <input name="class" type="radio" value="C0005">音效設備
            <input name="class" type="radio" value="C0006">日常用品
