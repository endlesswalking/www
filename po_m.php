...
<?php
	...
	if ((isset($_SESSION["nowId"]))  && (isset($_POST["content"])))
	{
		...
		if($borrow == true)
		{
			if($bId== "BB001")
			{
				header("Location:bBook.php");
			}
			else if($bId== "BB002")
			{
				header("Location:bComputer.php");
			}
			else if($bId== "BB003")
			{
				header("Location:bMeeting.php");
			}
			else if($bId== "BB004")
			{
				header("Location:bElectric.php");
			}
			else if($bId== "BB005")
			{
				header("Location:bMusic.php");
			}
			else if($bId== "BB006")
			{
				header("Location:bLife.php");
			}
		}
		else
		{
