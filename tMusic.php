        ...
        <div id="content">
			...
			<?php
				...
				@ mysql_set_charset('utf8');
			 	@ $query = mysql_query("SELECT equipment.eName,rStime,rEtime 
				                        FROM rent JOIN equipment ON rent.eId = equipment.eId JOIN class ON                                              equipment.cId = class.cId 
										WHERE class.cId='C0005' AND rent.rStime <= '$nowTime' AND rent.rEtime                                              > '$nowTime' ");
				$str1 = false;
				$str2 = false;
				...
				else
				{
                    ...
                    <caption>借出中的設備</caption>
					<tr><th width="150" height="60">名稱</th>
