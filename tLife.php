            ...
            <?php
				...
				@ mysql_set_charset('utf8');
			 	@ $query = mysql_query("SELECT equipment.eName,rStime,rEtime 
										...
										WHERE class.cId='C0006' AND rent.rStime <= '$nowTime' AND rent.rEtime                                              > '$nowTime' ");
				$str1 = false;
				$str2 = false;
